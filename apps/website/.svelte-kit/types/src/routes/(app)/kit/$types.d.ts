...
type LayoutRouteId = RouteId | "/(app)/kit" | "/(app)/kit/components/[slug]"
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(app)/kit/+page.server.js').load>>>>>>;
